export const allFacts = [
  {
    ...
    keyStats: [
      { label: "antennaConfig", value: "'64T64R MIMO'", icon: "📡" },
      { label: "beamforming", value: "'3D Adaptif'", icon: "📊" },
      { label: "kapasitas", value: "'10x Peningkatan'", icon: "📈" },
      { label: "pengguna", value: "'100 Simultan'", icon: "👥" },
      { label: "frekuensi", value: "'Sub-6GHz + mmWave'", icon: "📻" },
      { label: "efisiensi", value: "'5x Spektral'", icon: "⚡" }
    ],
  ...
  },
  {
    ...
    keyStats: [
      { label: "keahlian", value: "'Network Design'", icon: "💻" },
      { label: "protokol", value: "'TCP/IP, MPLS'", icon: "🔗" },
      { label: "teknologi", value: "'SDN, Cloud'", icon: "☁️" },
      { label: "layanan", value: "'Streaming, Gaming'", icon: "📺" },
      { label: "optimasi", value: "'QoS Management'", icon: "⚙️" },
      { label: "koneksi", value: "'Jutaan Simultan'", icon: "👥" }
    ],
  ...
  },
  {
    ...
    keyStats: [
      { label: "layanan", value: "'Global Calls'", icon: "💬" },
      { label: "streaming", value: "'Ultra HD Video'", icon: "📺" },
      { label: "monitoring", value: "'24/7 NOC'", icon: "👁️" },
      { label: "jaringan", value: "'Cross-Border'", icon: "🌐" },
      { label: "kualitas", value: "'QoE Optimal'", icon: "⭐" },
      { label: "koneksi", value: "'Seamless Global'", icon: "🔗" }
    ],
  ...
  },
  {
    ...
    keyStats: [
      { label: "remoteWork", value: "'Global Workforce'", icon: "👥" },
      { label: "telemedicine", value: "'Healthcare Access'", icon: "🏥" },
      { label: "education", value: "'Distance Learning'", icon: "📚" },
      { label: "socialMedia", value: "'Global Community'", icon: "💬" },
      { label: "smartCities", value: "'IoT Integration'", icon: "🏢" },
      { label: "ai", value: "'Future Foundation'", icon: "🤖" }
    ],
  ...
  },
  {
    ...
    keyStats: [
      { label: "tracking", value: "'Real-Time 3D'", icon: "🎯" },
      { label: "interferensi", value: "'-90% Reduction'", icon: "🛡️" },
      { label: "adaptif", value: "'ML Algorithm'", icon: "🤖" },
      { label: "presisi", value: "'Sub-Degree'", icon: "📏" },
      { label: "perangkat", value: "'Ratusan Simultan'", icon: "👥" },
      { label: "efisiensi", value: "'Spektral Optimal'", icon: "📈" }
    ],
  ...
  },
  {
    ...
    keyStats: [
      { label: "operasi", value: "'24/7 Non-Stop'", icon: "🕐" },
      { label: "monitoring", value: "'Real-Time'", icon: "👁️" },
      { label: "prediksi", value: "'AI Analytics'", icon: "🤖" },
      { label: "response", value: "'Instant Alert'", icon: "⚡" },
      { label: "coverage", value: "'Global Network'", icon: "🌐" },
